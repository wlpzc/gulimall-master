...
gulimall（商城） 项目是一套电商项目，包括前台商城系统以及后台管理系统，基于 SpringCloud + SpringCloudAlibaba + MyBatis-Plus实现，采用 Docker 容器化部署。前台商城系统包括：用户登录、注册、商品搜索、商品详情、购物车、下订单流程、秒杀活动等模块。后台管理系统包括：系统管理、商品系统、优惠营销、库存系统、订单系统、用户系统、内容管理等七大模块。
...
```
192.168.31.61	gulimall.com
192.168.31.61	search.gulimall.com
192.168.31.61  item.gulimall.com
192.168.31.61  auth.gulimall.com
192.168.31.61  cart.gulimall.com
192.168.31.61  order.gulimall.com
192.168.31.61  member.gulimall.com
192.168.31.61  seckill.gulimall.com
以上端口换成自己Linux的ip地址
```
